...
using Booln.MesZero.Authentication.TwoFactor.Google;
using Booln.MesZero.Authorization.Users.Dto;
using Booln.MesZero.Authorization.Users.Profile.Cache;
using Booln.MesZero.Authorization.Users.Profile.Dto;
using Booln.MesZero.Friendships;
using Booln.MesZero.Identity;
using Booln.MesZero.Security;
using Booln.MesZero.Storage;
using Booln.MesZero.Timing;

namespace Booln.MesZero.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : AbpZeroTemplateAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("Booln.MesZero",
        ...
        public async Task<UpdateGoogleAuthenticatorKeyOutput> UpdateGoogleAuthenticatorKey()
        {
            ...
            {
                QrCodeSetupImageUrl = _googleTwoFactorAuthenticateService.GenerateSetupCode("Booln.MesZero",
                    user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300).QrCodeSetupImageUrl
            };
        }
